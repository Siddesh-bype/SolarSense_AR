...
class _ARCameraScreenState extends State<ARCameraScreen>
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // ── AR overlay: scanning UI or 3D panels ─────────────────────────
          Center(
            child: _isScanning ? _buildScanningUI() : _buildPanelOverlay(),
          ),
          ...
          if (!_isScanning)
            Positioned(
              ...
              child: Column(
                children: [
                  _glassButton(
                      Icons.add, () => setState(() => _panelCount++)),
                  ...
                  const SizedBox(height: 16),
                  Container(
                      width: 40, height: 1, color: Colors.white24),
                  const SizedBox(height: 16),
  ...
  Widget _buildPanelOverlay() {
    return Stack(
      ...
      children: [
        ...
        // 3D isometric panel render
        SolarPanel3DWidget(panelCount: _panelCount, size: 300),

        // kW output pill below
        Positioned(
          bottom: 0,
          child: Container(
            padding:
  ...
  // ── Scanning UI (animated brackets + scan line) ───────────────────────────
  ...
  Widget _buildScanningUI() {
    return Stack(
      ...
      children: [
        ...
        Positioned(
            top: 0, left: 0, child: _cornerBracket(true, true)),
        Positioned(
            top: 0, right: 0, child: _cornerBracket(true, false)),
        Positioned(
            bottom: 0, left: 0, child: _cornerBracket(false, true)),
        Positioned(
            bottom: 0, right: 0, child: _cornerBracket(false, false)),
        AnimatedBuilder(
  ...
  Widget _cornerBracket(bool top, bool left) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          top: top
              ? const BorderSide(color: Color(0xFFf97316), width: 4)
              : BorderSide.none,
          bottom: !top
              ? const BorderSide(color: Color(0xFFf97316), width: 4)
              : BorderSide.none,
